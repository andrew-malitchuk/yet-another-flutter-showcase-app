...
class _ButtonState extends State<NavButton> with TickerProviderStateMixin {
  late bool _expanded;
        ...
        child: Container(
          ...
          child: AnimatedContainer(
            ...
            child: FittedBox(
              ...
              child: Builder(
                builder: (_) {
                  if (widget.style == NavStyle.google) {
                    return Stack(
                      children: [
                        if (widget.text!.data != '')
                          Row(
                              ...
                              children: [
                                Opacity(
                                  ...
                                  child: SvgPicture.asset(
                                      widget.icon, // Path to your SVG file
                  ...
                  } else if (widget.style == NavStyle.oldSchool) {
                    return Column(
                      children: [
                        SvgPicture.asset(widget.icon, // Path to your SVG file
                            height: 24, // Adjust the size
                            width: 24,
                            color: colorTweenAnimation.value),
                        Container(
