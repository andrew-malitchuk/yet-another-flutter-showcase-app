...
class _LoadingDotsState extends State<LoadingDots>
  ...
  Widget _rotatingDots({
    ...
    final double angle = Tween<double>(begin: initialAngle, end: finalAngle)
                ...
                angle: Tween<double>(
                  begin: math.pi / 8,
                    ...
                    .animate(
                      CurvedAnimation(
                        parent: _animationController,
                        curve: const Interval(0.18, 0.36),
                      ),
                    )
                    .value,
                child: _animatingDots(
