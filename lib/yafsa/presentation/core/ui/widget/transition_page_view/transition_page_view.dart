...
import 'package:yafsa/yafsa/presentation/core/ui/widget/transition_page_view/transition_animation.dart';
...
class TransitionPageViewController {
  ...
  ///   pages.
  TransitionPageViewController([int startingPage = 0, int? pageCount]) {
  ...
  TransitionPageViewState _state = TransitionPageViewState.visible;
...
enum TransitionPageViewState { visible, fadeIn, fadeOut }
...
class TransitionPageView extends StatefulWidget {
  ...
  final TransitionPageViewController controller;
...
class _TransitionPageViewState extends State<TransitionPageView> {
  ...
  void _changePage(int pageNumber) {
    widget.controller._state = TransitionPageViewState.fadeOut;
    widget.controller._nextVisiblePageNumber = pageNumber;
    _updateContent();
  }

  void _changePageHandler(int pageNumber) {
    if (widget.controller._state == TransitionPageViewState.fadeOut) {
      widget.controller._nextVisiblePageNumber = pageNumber;
    }
    if (widget.controller._state == TransitionPageViewState.fadeIn) {
  ...
  Widget build(BuildContext context) {
    ...
    if ((widget.controller._state != TransitionPageViewState.visible) &&
    ...
    switch (widget.controller._state) {
      case TransitionPageViewState.visible:
        ...
        break;
      case TransitionPageViewState.fadeIn:
        widget.controller._enabled = false;
        child = TransitionAnimation(
            duration: widget.fadeInDuration,
            onShown: () {
              widget.controller._state = TransitionPageViewState.visible;
            ...
            child: child);
        break;
      case TransitionPageViewState.fadeOut:
        widget.controller._enabled = false;
        child = TransitionAnimation(
            duration: widget.fadeOutDuration,
            onHidden: () {
              widget.controller._state = TransitionPageViewState.fadeIn;
